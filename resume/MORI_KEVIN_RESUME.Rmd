...
* Spearhead Mazda's data governance framework, tasked with maintaining oversight over data policies, standards, use cases, and security.  This initiative has led to a 27% reduction in enterprise data costs while increasing data availability and quality. 
...
* Coursework includes statistical computing, statistical and machine learning, categorical data analysis, multivariate statistics, Bayesian statistics. 
